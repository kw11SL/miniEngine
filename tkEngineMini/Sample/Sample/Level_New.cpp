...
void Level_New::CreateMapChipRender(const LevelObjectData& objData, const char* filePath)
{
	//フックされなかったので、マップチップを作成する。
	auto mapChipRender = std::make_shared<MapChip_New>(objData, filePath);
...
void Level_New::MatrixTklToLevel()
{
...
void Level_New::Draw(RenderContext& rc)
{
